...
export default function Login() {
    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-12">
            ...
            <div className="relative w-full max-w-6xl flex items-center gap-8">
                {/* Left side - Login Form */}
                <div className="w-full lg:w-1/2">
                    {/* Card */}
                    <div className="card p-8 backdrop-blur-xl bg-white/80 border border-white/50 shadow-2xl max-w-md mx-auto lg:mx-0">
                        {/* Logo */}
                    ...
                    {/* Trust badges */}
                    <div className="mt-6 flex justify-center lg:justify-start lg:ml-4 items-center gap-6 text-xs text-slate-500">
                ...
                <div className="hidden lg:block w-1/2 h-[600px]">
                    <spline-viewer
                        url="https://prod.spline.design/7uUq6iZWzLRi0Pz6/scene.splinecode"
